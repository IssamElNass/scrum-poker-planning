...
export function CreateRoomForm() {
  ...
  const [selectedVotingSystem, setSelectedVotingSystem] =
    useState<VotingSystemType>(DEFAULT_VOTING_SYSTEM);
  ...
  const handleCreate = async () => {
    ...
    if (!roomName.trim()) {
      toast.error("Please enter a planning session name");
      return;
    }
    ...
    try {
      // Create the room
      const roomResult = await apiClient.createRoom({
        name: roomName.trim(),
      ...
      // Create user and join the room
      const userResult = await apiClient.joinRoom(
        newRoomId,
        userName.trim(),
        isSpectator
      );
      ...
      if (!userResult.success || !userResult.data) {
        toast.error(userResult.error || "Failed to join room");
        return;
      }
      ...
      let errorMessage = "Failed to create planning session";
        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-8 rounded-3xl shadow-2xl ring-1 ring-gray-200/50 dark:ring-gray-800/50 border-0">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 font-medium">
              Set up your team&apos;s estimation session
            </p>
          </div>

          <div className="space-y-6">
            {/* Planning Session Name input */}
            <div className="space-y-3">
              ...
              <Input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" && userName.trim()) handleCreate();
                }}
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" && roomName.trim()) handleCreate();
                }}
                className="h-12 rounded-xl border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-primary focus:border-primary text-base"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <Input
                id="password"
                type="password"
                placeholder="Set a password to protect this room"
                value={password}
            ...
            <Button
              ...
              disabled={
                !userName.trim() || !roomName.trim() || isCreating
              }
            ...
            <div className="text-center">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                {isSpectator
                  ...
                  : "As the session creator, you'll be the owner and can manage settings"}
              </p>
            </div>
          </div>
        </div>
